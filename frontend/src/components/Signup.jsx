/*
 * Signup — Dark glass modal with frosted overlay
 */
...
export default function Signup({ onClose, switchToLogin }) {
    ...
    const handleChange = (e) => {
        ...
        if (error) clearError(); if (localError) setLocalError('');
    };
        ...
        >
            <motion.div
                ...
                style={{
                    ...
                    padding: '44px 40px', borderRadius: 28, width: 420, maxWidth: '92vw',
            ...
            >
                ...
                <div style={{ textAlign: 'center', marginBottom: 28 }}>
                    ...
                    <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '1.3rem', color: 'var(--text-primary)', marginTop: 8, fontWeight: 500 }}>Create Account</h2>
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem', marginTop: 4 }}>Join us to explore luxury fragrances</p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    {[
                        ...
                        <div key={field.name} style={{ marginBottom: 18 }}>
                            <label style={{ display: 'block', marginBottom: 8, color: 'var(--text-secondary)', fontWeight: 500, fontSize: '0.85rem' }}>{field.label}</label>
                            <input type={field.type} name={field.name} value={formData[field.name]} onChange={handleChange} required style={inputStyle}
                    ...
                    <div style={{ marginBottom: 28 }}>
                        <label style={{ display: 'block', marginBottom: 8, color: 'var(--text-secondary)', fontWeight: 500, fontSize: '0.85rem' }}>Confirm Password</label>
                ...
                <p style={{ textAlign: 'center', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
                    ...
                    <button onClick={switchToLogin} style={{ background: 'none', border: 'none', color: '#d4af37', cursor: 'pointer', fontSize: '0.85rem', fontWeight: 600, textDecoration: 'underline' }}>Sign in</button>
                </p>
            </motion.div>
        </motion.div>
    );
